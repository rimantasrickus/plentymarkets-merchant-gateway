...
class BuyNowButtonContainer
{
    ...
    public function call(
        ...
        $data = [
            ...
            'creditCard' => PluginConfiguration::PAYMENT_KEY_CARDS,
            'sepa' => PluginConfiguration::PAYMENT_KEY_DIRECT_DEBIT,
            'sepaGuaranteed' => PluginConfiguration::PAYMENT_KEY_DIRECT_DEBIT_GUARANTEED,
            ...
            'flexipay' => PluginConfiguration::PAYMENT_KEY_FLEXIPAY_DIRECT
        ];
