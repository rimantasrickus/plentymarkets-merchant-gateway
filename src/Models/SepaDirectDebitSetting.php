...
/**
 * SEPA Direct Debit settings model
 *
 ...
 */
class SepaDirectDebitSetting extends Model
{
     ...
     * @param array $data
     *
     * @return SepaDirectDebitSetting
     */
    public function set($data): SepaDirectDebitSetting
    {
